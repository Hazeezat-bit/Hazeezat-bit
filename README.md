...
MSc Data Science from the University of Padua, with hands-on experience across **healthcare analytics**, **global trade data**, and **retail intelligence**. I build end-to-end pipelines, write analytical SQL, and communicate findings through dashboards and visualisations that non-technical stakeholders actually use.
...
`Python` `pandas` `Tableau` `EDA` `Retail analytics`

🔗 [Live Tableau dashboard →](https://public.tableau.com/views/SephoraProductPerformanceDashboard/Dashboard1)
...
- 🎓 **MSc Data Science** — University of Padua, Italy
